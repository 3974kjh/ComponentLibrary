export type FormatNumberStyle = 'decimal' | 'currency' | 'percent' | 'unit' | 'none' | 'integer' | 'percentRound' | 'metric';
...
export declare function formatNumber(number: number | null | undefined, options?: FormatNumberOptions): string;
/**
