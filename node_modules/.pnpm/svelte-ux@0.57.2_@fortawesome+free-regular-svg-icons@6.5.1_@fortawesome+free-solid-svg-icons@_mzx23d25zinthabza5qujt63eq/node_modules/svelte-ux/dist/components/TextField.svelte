...
export let label = '';
export let labelPlacement = 'inset';
export let value = ''; // TODO: Can also include operator: { "operator": "value" }
...
export let actions = autofocus
    ? (node) => [autoFocus(node, typeof autofocus === 'object' ? autofocus : undefined)]
    : undefined;
export let operators = undefined;
export let inputEl = null;
export let debounceChange = false;
export let classes = {};
